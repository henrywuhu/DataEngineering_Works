...
def main():
    ...
    ''''
        spark = (SparkSession.builder
             ...
             .appName("HiveLocalConnection")
             .config("hive.metastore.uris", "thrift://localhost:9083")
             .enableHiveSupport()Tarea_1/pyspark_shell.py
             .getOrCreate())
    '''
    ...
    try:
        ...
        df = spark.read.option("header","true").csv("/ingest/aeropuerto.csv",sep=';')
        cols_drop = ['fir','inhab']
        ...
        df2 = spark.read.option("header","true").csv("/ingest/informe_1.csv",sep=';')
        cols_drop = ['Calidad dato']
        df2_select = df2.drop(*cols_drop)
        df2_select = df2_select.withColumn('Fecha',to_date(df2_select['Fecha'],'mm/dd/yyyy'))
        ...
        df3 = spark.read.option("header","true").csv("/ingest/informe_2.csv",sep=';')
        cols_drop = ['Calidad dato']
